...
public class EventListenerWindowBuilder extends JFrame implements ActionListener {
	...
	private void initComponents() {
		...
		JButton btn1 = new JButton("외부 클래스");
		contentPane.add(btn1);
		
		JButton btn2 = new JButton("내부 클래스");
		btn2.addActionListener(new BtnNewButton_1ActionListener());
		...
		btn4.addActionListener(new BtnNewButton_3ActionListener());
		...
		btn8.addMouseListener(new MouseListener() {
			...
			public void mousePressed(MouseEvent e) {
				JOptionPane.showMessageDialog(null, "mouserPressed");
		...
		btn9.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mousePressed(MouseEvent e) {
				JOptionPane.showMessageDialog(null, "mouserPressed()-2");
